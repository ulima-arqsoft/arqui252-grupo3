...
El **patrón Throttling** propone **controlar la tasa de solicitudes** que un sistema puede procesar en un período determinado, protegiendo así el servidor de sobrecargas.
